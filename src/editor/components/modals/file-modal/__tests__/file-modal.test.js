...
describe("file-modal/index.jsx", () => {
  ...
  it("getSavedFileMetadata", () => {
    expect(fmu.getSavedFileMetadata("example1.jpg")).toMatchObject({
      name: "example1.jpg",
      fileKey: "0",
      id: 215
    });
    expect(fmu.getSavedFileMetadata("example2.jpg")).toMatchObject({
      name: "example2.jpg",
      fileKey: "1",
      id: 321
    });
    expect(fmu.getSavedFileMetadata("example3.jpg")).toMatchObject({
      name: "example3.jpg",
      fileKey: "2",
      id: 892
    });
