...
import { PresentationModeToolbarUnconnected, mapStateToProps } from '../presentation-mode-toolbar'
...
describe('PresentationModeToolbarUnconnected', () => {
  ...
  const wrapper = () => {
    if (!mountedComponent) {
      mountedComponent = shallow(<PresentationModeToolbarUnconnected {...props} />)
    }
