...
const states = [
  {
    kernelState: 'KERNEL_BUSY', color: undefined, kernelText: 'Kernel Busy', statusIcon: CircularProgress,
  },
  {
    kernelState: 'KERNEL_LOADING', color: undefined, kernelText: 'Kernel Loading', statusIcon: CircularProgress,
  },
  {
    kernelState: 'KERNEL_IDLE', color: 'forestgreen', kernelText: 'Kernel Idle', statusIcon: PanoramaFishEye,
  },
  {
    kernelState: 'KERNEL_ERROR', color: 'gray', kernelText: 'Kernel Error', statusIcon: ErrorOutline,
  },
  {
    kernelState: 'KERNEL_LOAD_ERROR', color: 'red', kernelText: 'Kernel Didn\'t Load', statusIcon: Error,
  },
]
