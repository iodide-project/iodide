...
- Please keep unstructured critique to a minimum. If you have solid ideas you want to experiment with, make a fork and see how it works. All feedback should be constructive in nature. If you need guidance around giving feedback, consult Digital Ocean’s Code of Conduct.
...
11. The enforcement policies listed above apply to all official IODIDE venues; [LIST OF IODIDE VENUES, IRC, GH, CONFERENCES, GITTER, etc.]  If you wish to use this code of conduct for your own project, consider explicitly mentioning your moderation policy or making a copy with your own moderation policy so as to avoid confusion.
